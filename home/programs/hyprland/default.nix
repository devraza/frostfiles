  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      general = {
        ...
        gaps_out = "12";
        border_size = "2";
        "col.active_border" = "rgba(a292e8ff) rgba(e887bbff) 45deg";
      ...
      bind = [
        ...
        "$mod SHIFT, p, exec, noctalia-shell ipc call lockScreen lock"
        "$mod, f, fullscreen"
        "$mod SHIFT, c, killactive"
        "$mod SHIFT, q, exit"
        "$mod SHIFT, q, exec, noctalia-shell ipc call sessionMenu toggle"
