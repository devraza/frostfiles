...
c.url.searchengines = {
    'DEFAULT':  'http://devraza.duckdns.org/search?q={}',
...
def colorscheme(c, options = {}):
    ...
    ## Foreground of the matched text in the selected completion item.
    c.colors.completion.item.selected.match.fg = palette['blue']
