{ config, pkgs, inputs, lib, ... }:
{
  ...
  users.users.devraza = {
    isNormalUser = true;
    extraGroups = [ "wheel" "video" "audio" "networkmanager" "docker" ]; # Add some groups
    openssh.authorizedKeys.keys = [
      ...
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIBT53rebM7x0sCVmqOn07kJYe3bXV3O563aampy2AVd Generated By Termius"
    ];
  };
