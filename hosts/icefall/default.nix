{ config, pkgs, inputs, lib, ... }:
{
  ...
  services.cron.systemCronJobs = [
    ...
    "0 19 * * * root ${pkgs.restic}/bin/restic --repo /var/lib/backup backup /mnt/codebreaker/Documents /var/lib --exclude-file /var/lib/backup/exclude.txt -p /etc/backup.key"
  ];
